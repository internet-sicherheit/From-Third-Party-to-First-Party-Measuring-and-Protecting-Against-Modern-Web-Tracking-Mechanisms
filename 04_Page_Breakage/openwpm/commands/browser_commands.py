...
def _stitch_screenshot_parts(visit_id, browser_id, manager_params, suffix):
...
class ScreenshotFullPageCommand(BaseCommand):
    ...
    def execute(
        ...
        _stitch_screenshot_parts(self.visit_id, self.browser_id, manager_params, self.suffix)
