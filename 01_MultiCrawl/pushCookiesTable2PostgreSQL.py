...
CONSTRING = "user=sst  password=oHg10&c15#!- host=10.0.12.218 port=5432 dbname=server-side-measurement-data"
...
if __name__ == '__main__':
    for folder in tqdm(FOLDER_W_PATH, total=len(FOLDER_W_PATH), desc='Processing SQLite Databases'):
        ...
        if len(already_analyzed) != 1:
            ...
            if len(cookies) > 0:
                insertIntoPostgreSQL('cookies', cookies, folder_name)
