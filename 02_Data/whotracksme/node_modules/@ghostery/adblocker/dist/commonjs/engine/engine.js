...
const url_parser_1 = require("@ghostery/url-parser");
const config_js_1 = __importDefault(require("../config.js"));
const data_view_js_1 = require("../data-view.js");
const events_js_1 = require("../events.js");
const fetch_js_1 = require("../fetch.js");
const cosmetic_js_1 = require("../filters/cosmetic.js");
...
const cosmetic_js_2 = __importDefault(require("./bucket/cosmetic.js"));
...
class FilterEngine extends events_js_1.EventEmitter {
    ...
    static deserialize(serialized) {
        ...
        engine.removeparams = network_js_1.default.deserialize(buffer, config);
        ...
        engine.cosmetics = cosmetic_js_2.default.deserialize(buffer, config);
    ...
    cosmeticFilters = [], networkFilters = [], preprocessors = [], config = new config_js_1.default(), lists = new Map(), } = {}) {
        ...
        // $removeparam
        this.removeparams = new network_js_1.default({ config: this.config });
        // All other filters
        this.filters = new network_js_1.default({ config: this.config });
        // Cosmetic filters
        this.cosmetics = new cosmetic_js_2.default({ config: this.config });
        // HTML filters
    ...
    classes, hrefs, ids, getRulesFromDOM = true, getRulesFromHostname = true, getInjectionRules, getExtendedRules, callerContext, }) {
        ...
        for (const unhide of unhides) {
            if (unhide.isScriptInject() === true &&
                ...
                unhideExceptions.set((0, cosmetic_js_1.normalizeSelector)(unhide, this.resources.getScriptletCanonicalName.bind(this.resources)), unhide);
            }
        }
        for (const filter of filters) {
            ...
            let exception = unhideExceptions.get((0, cosmetic_js_1.normalizeSelector)(filter, this.resources.getScriptletCanonicalName.bind(this.resources)));
            ...
            if (result.filter === undefined) {
                ...
                if (result.filter === undefined) {
                    ...
                    if (searchParamSeparatorIndex !== -1 &&
                        ...
                        const searchParams = new url_parser_1.URLSearchParams(searchParamLiteral);
                        let modified = false;
                        ...
                        for (const [key, filter] of removeparamFilters) {
                            ...
                            if (key === '') {
                                ...
                                this.emit('filter-matched', { filter, exception: removeparamIgnoreFilter }, { request, filterType: lists_js_1.FilterType.NETWORK });
                                break;
                            }
                            if (!key.startsWith('~') &&
