...
export declare const ENGINE_VERSION = 811;
...
export default class FilterEngine extends EventEmitter<EngineEventHandlers> {
    ...
    removeparams: NetworkFilterBucket;
     ...
     */
    injectCosmeticFilters(filters: CosmeticFilter[], { url, injectStyles, injectScriptlets, injectExtended, allowGenericHides, getBaseRules, hidingStyle, }: {
        url: string;
    ...
    matchCosmeticFilters({ url, hostname, domain, classes, hrefs, ids, getRulesFromDOM, getRulesFromHostname, getInjectionRules, getExtendedRules, callerContext, }: {
        url: string;
        hostname: string;
        domain: string | null | undefined;
        classes?: string[] | undefined;
