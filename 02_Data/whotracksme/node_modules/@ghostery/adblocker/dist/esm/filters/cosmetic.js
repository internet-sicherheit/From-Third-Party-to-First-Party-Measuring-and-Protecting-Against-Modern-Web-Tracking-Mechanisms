 ...
 */
import { classifySelector, SelectorType, parse as parseCssSelector, } from '@ghostery/adblocker-extended-selectors';
...
import { fastHash, fastHashBetween, getBit, hasUnicode, setBit, tokenize, HASH_SEED, HASH_INTERNAL_MULT, } from '../utils.js';
...
export function normalizeSelector(filter, getScriptletCanonicalName) {
