 ...
 */
import { AST } from '@ghostery/adblocker-extended-selectors';
...
export declare function normalizeSelector(filter: CosmeticFilter, getScriptletCanonicalName: (name: string) => string | undefined): string;
/***************************************************************************
...
export default class CosmeticFilter implements IFilter {
    ...
    getScript(getScriptlet: (_: string) => string | undefined): string | undefined;
