(() => {
    ...
    var e = {
            456: (e, n, t) => {
                ...
                class r {
                    ...
                    static getConsentValues() {
                        return new Promise(((e, n) => {
                            chrome.storage.sync.get({
                                consentValues: r.defaultValues
                            }, (n => {
                                e(Object.assign({}, r.defaultValues, n.consentValues))
                            }))
                        }))
                    }
                    static getDebugValues() {
                        return new Promise(((e, n) => {
                            chrome.storage.sync.get({
                                ...
                                e(Object.assign({}, r.defaultDebugFlags, n.debugFlags))
                            }))
                        }))
                    }
                    static getGeneralSettings() {
                        return new Promise(((e, n) => {
                            chrome.storage.sync.get({
                                ...
                                e(Object.assign({}, r.defaultSettings, n.generalSettings))
                            }))
                        }))
                    }
                    ...
                    static removeRuleList(e) {
                        return new Promise(((n, t) => {
                            r.getRuleLists().then((t => {
                                r.setRuleLists(t.filter((n => n !== e))).then((() => {
                                    n()
                                }))
                            }))
                        }))
                    }
                    static addRuleList(e) {
                        return new Promise(((n, t) => {
                            r.getRuleLists().then((t => {
                                t.push(e), r.setRuleLists(t).then((() => {
                                    n()
                                }))
                            }))
                        }))
                    ...
                    static setPageActive(e, n) {
                        return new Promise(((t, r) => {
                            chrome.storage.sync.get({
                                ...
                                n ? delete r[e] : r[e] = !0, chrome.storage.sync.set({
                                    disabledPages: r
                                }, (() => {
                                    t()
                                }))
                    ...
                    static async getDebugFlags() {
                        ...
                        return [{
                            ...
                            value: e.alwaysForceRulesUpdate
                        }, {
                            name: "skipHideMethod",
                            description: "[[SKIP_HIDE_DESCRIPTION]]",
                            value: e.skipHideMethod
                        }, {
                            name: "debugLog",
                    ...
                    static setConsentValues(e) {
                        return new Promise(((n, t) => {
                            e = Object.assign({}, r.defaultValues, e), chrome.storage.sync.set({
                                consentValues: e
                            }, (() => {
                                n()
                            }))
                ...
                }, r.defaultRuleLists = ["https://raw.githubusercontent.com/cavi-au/Consent-O-Matic/master/rules-list.json"]
            },
            213: (e, n, t) => {
                t.d(n, {
                    A: () => a
                ...
                class a {
                    static getString(e, n) {
                        let t = navigator.language.substring(0, 2);
                        null == t && (t = "en");
                        let i = "[" + e + "-" + t + "]";
                        if (null != r[e]) {
                            const n = r[e];
                            null != n[t] ? i = n[t] : (console.warn("Missing translation [" + t + "] for key: ", e, n), a.debugTranslations || null != n.en && (i = n.en))
                        } else a.debugTranslations && console.log("%c Unknown translation key:", "background: red; color: white;", e);
                    ...
                    static doLanguage(e) {
                        ...
                        null == n && (n = "en"), document.querySelector("html").lang = n;
                        const t = document.createTreeWalker(e, NodeFilter.SHOW_TEXT);
                        let r = /\[\[(\S+)\]\]/g;
                        for (; t.nextNode();) {
                            let e = t.currentNode.nodeValue.matchAll(r);
                            for (let n of e) {
                                let e = a.getString(n[1], []);
                                t.currentNode.nodeValue = t.currentNode.nodeValue.replace(n[0], e)
                            }
                        }
                    }
                    static doAttributes(e) {
                        ...
                        e.querySelectorAll("*").forEach((e => {
                            Array.from(e.attributes).forEach((e => {
                                let t = e.value.matchAll(n);
                                for (let n of t) {
                                    let t = a.getString(n[1], []);
                                    e.value = e.value.replace(n[0], t)
                                }
                            }))
                        }))
                    }
            ...
            609: (e, n, t) => {
                var r = t(456),
                    a = t(213);
                let i = document.querySelector(".configurator ul.categorylist");
                if (i) {
                    let s = document.querySelector(".configurator .tab_rl .rulelist"),
                        o = document.querySelector(".configurator .tab_dbg ul.flags"),
                        d = document.querySelector(".configurator .tab_about table.logList");
                    i.innerHTML = "";
                    let l = document.querySelectorAll(".header .menuitem");

                    function u(e, n, t, r, i) {
                        let s = document.createElement("li");
                        s.setAttribute("data-name", t);
                        let o = ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, (e => (e ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e / 4).toString(16)));
                        const d = `\n            <label class="slider" for="${n}">\n                    <input type="checkbox" id="${n}" ${i?"checked":""}>\n                    <div class="knob" role="checkbox" aria-checked="${i?"true":"false"}" tabindex="0" aria-labelledby="${o}"></div>\n            </label>\n            <h2 id=${o}>${t}</h2>\n            <div class="category_description">\n    ${r}\n            </div>`;
                        let l = (new DOMParser).parseFromString(d, "text/html").querySelector("body");
                        for (let e of l.childNodes) s.appendChild(e);

                        function u() {
                            let e = s.querySelector("input");
                            e.checked = !e.checked, s.querySelector(".knob").setAttribute("aria-checked", "" + e.checked), e.checked ? s.classList.add("active") : s.classList.remove("active"), p()
                        }
                        return e.appendChild(s), s.addEventListener("click", (function(e) {
                            u(), e.stopPropagation()
                        })), s.addEventListener("keydown", (function(e) {
                            "Space" === e.code && (u(), e.stopPropagation())
                        })), a.A.doLanguage(s), s
                    }

                    function c() {
                        r.A.getRuleLists().then((e => {
                            s.innerHTML = "", e.forEach((e => {
                                let n = document.createElement("li"),
                                    t = document.createElement("button"),
                                    a = document.createElement("a");
                                a.href = e, a.innerText = e, t.innerText = "X", n.appendChild(t), n.appendChild(a), s.appendChild(n), t.addEventListener("click", (function() {
                                    r.A.removeRuleList(e).then((() => {
                                        c()
                                    }))
                                }))
                            }))
                    ...
                    function m(e) {
                        let n = document.querySelector(".header .menuitem[tabindex='0']");
                        null != n && n.setAttribute("tabindex", -1), l.forEach((e => {
                            e.classList.remove("active"), e.setAttribute("aria-selected", !1)
                        })), document.querySelectorAll(".tab").forEach((e => {
                            e.style.display = "none"
                        })), e.classList.add("active"), e.setAttribute("aria-selected", !0), e.setAttribute("tabindex", 0), document.querySelectorAll(".configurator .tab").forEach((e => {
                            e.style.display = "none"
                        })), document.getElementById(e.getAttribute("aria-controls")).style.display = "block", e.focus(), g()
                    }

                    function p() {
                        let e = {};
                        i.querySelectorAll("li input").forEach((n => {
                            e[n.id] = n.checked
                        })), r.A.setConsentValues(e);
                        let n = {};
                        o.querySelectorAll("li input").forEach((e => {
                            n[e.id] = e.checked
                        })), r.A.setDebugValues(n)
                    }

                    function g() {
                        d.querySelectorAll("tr:not(:first-child)").forEach((e => {
                            e.remove()
                        })), r.A.getStatistics().then((e => {
                            document.querySelector("#clicks").innerText = e.clicks;
                            for (const [n, t] of Object.entries(e.cmps)) {
                                let e = document.createElement("tr"),
                                    r = document.createElement("th");
                                r.innerText = n, e.appendChild(r), r = document.createElement("td"), r.innerText = t.filledForms, e.appendChild(r), r = document.createElement("td"), r.innerText = t.clicks, e.appendChild(r), d.append(e)
                            }
                        }))
                    }
                    l.forEach((e => {
                        e.addEventListener("click", (n => {
                            ...
                            console.log(n.code);
                            let t = null;
                            "ArrowRight" === n.code ? (t = e.nextElementSibling, null == t && (t = l[0])) : "ArrowLeft" === n.code && (t = e.previousElementSibling, null == t && (t = l[l.length - 1])), null != t && m(t)
                        }))
                    })), r.A.getGeneralSettings().then((e => {
                        let n = document.querySelector("#generalTab #hideOrPip"),
                            t = n.elements.hideOrPip;
                        e.hideInsteadOfPIP ? t.value = "hide" : t.value = "pip", n.addEventListener("input", (() => {
                            ! function() {
                                const e = {
                                    hideInsteadOfPIP: "hide" === t.value
                                };
                                r.A.setGeneralSettings(e)
                            }()
                        }))
                    })), r.A.getConsentTypes().then((e => {
                        e.forEach((e => {
                            u(i, e.type, a.A.getString(e.name), a.A.getString(e.description), e.value)
                        }))
                    })), r.A.getDebugFlags().then((e => {
                        e.forEach((e => {
                            let n = u(o, e.name, e.name, e.description, e.value),
                                t = n.querySelector("input");
                            t.addEventListener("input", (function(e) {
                                this.checked ? this.parentNode.parentNode.classList.add("active") : this.parentNode.parentNode.classList.remove("active"), p()
                            })), t.checked && n.classList.add("active")
                        }))
                    })), document.querySelector("#clearDebugFlags").addEventListener("click", (() => {
                        r.A.setDebugValues({}).then((() => {
                            r.A.getDebugFlags().then((e => {
                                e.forEach((e => {
                                    let n = document.querySelector("ul.flags li[data-name='" + e.name + "']");
                                    n.querySelector("input").checked = e.value, e.value || n.classList.remove("active")
                                }))
                            }))
                        }))
                    })), c(), document.querySelector("#urladd").addEventListener("click", (function(e) {
                        let n = document.querySelector("#newurl").value;
                        document.querySelector("#newurl").value = "", r.A.addRuleList(n).then((() => {
                            c()
                        }))
                    ...
                    let f = "undefined" != typeof browser ? browser.permissions : chrome.permissions;
                    if (f) {
                        function h() {
                            f.getAll().then((e => {
                                console.log(e), e && e.origins && e.permissions && (e.origins.includes("<all_urls>") || e.origins.includes("*://*/*")) && e.permissions.includes("tabs") && e.permissions.includes("activeTab") && e.permissions.includes("storage") ? document.querySelector("#permissions").style.display = "none" : (document.querySelector("#permissions").style.display = "block", setTimeout(h, 1500))
                            }))
                        }
                        document.querySelector("#permissions button").addEventListener("click", (() => {
                            f.request({
                                ...
                                h(), document.querySelector("#failedpermissions").style.display = "block"
                            }))
                        })), h()
                    }
                    a.A.doLanguage()
            ...
            333: (e, n, t) => {
                var r = t(456),
                    a = t(213);
                document.querySelector(".fronttab") && (chrome.tabs.query({
                    active: !0,
                    currentWindow: !0
                }, (e => {
                    const n = new URL(e[0].url).host;
                    let t = document.querySelector(".siteselector input");
                    document.querySelector("#site").textContent = n, document.querySelector("#unhandled_site").textContent = n, document.querySelector("#settings").addEventListener("click", (function() {
                        chrome.runtime.openOptionsPage(), window.close()
                    })), r.A.isActive(n).then((e => {
                        t.checked = e
                    })), t.addEventListener("input", (() => {
                        r.A.setPageActive(n, t.checked)
                    })), r.A.getDebugValues().then((e => {
                        let t = document.querySelector("#no-confirmation");
                        t.checked = !0 === e.skipSubmitConfirmation, t.addEventListener("input", (() => {
                            e.skipSubmitConfirmation = t.checked, r.A.setValuesFlags(e)
                        })), document.querySelector("#unhandled").addEventListener("click", (() => {
                            document.querySelector(".fronttab").style.display = "none", document.querySelector(".unhandledtab").style.display = "block", e.skipSubmitConfirmation && document.querySelector("#unhandled_send").click()
                        })), document.querySelector("#unhandled_cancel").addEventListener("click", (() => {
                            document.querySelector(".unhandledtab").style.display = "none", document.querySelector(".fronttab").style.display = "block", window.close()
                        })), document.querySelector("#unhandled_send").addEventListener("click", (() => {
                            fetch("https://gdprconsent.projects.cavi.au.dk/report.php?url=" + encodeURIComponent(n)), document.querySelector(".unhandledtab").style.display = "none", document.querySelector(".unhandledtab_complete").style.display = "block", setTimeout((() => {
                                window.close()
                            }), 1250)
                        }))
                    }))
            ...
            152: (e, n, t) => {
                e.exports = t.p + "options.html"
            },
            824: (e, n, t) => {
                e.exports = t.p + "popup.html"
            },
            917: (e, n, t) => {
                e.exports = t.p + "ui.css"
            }
        },
        n = {};
    ...
    }, t.o = (e, n) => Object.prototype.hasOwnProperty.call(e, n), t.p = "", t(609), t(333), t(917), t(824), t(152)
})();